...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
			<div class="ContactForm">
				<div class="ContactForm-successMessage">
					<div class="ContactForm-seccessMessageText">Message received! We'll be in touch soon.</div>
				</div>
				<h1 class="ContactForm-pageTitle">Contact Form Demo</h1>
				<div class="ContactForm-belowTitleSection">
					<div class="ContactForm-imageAndTextPlaceholder"><p>Text + Right Aligned Image in Two Lines</p></div>
					<div class="ContactForm-imageAndTextPlaceholder"><p>Text + Right Aligned Image</p></div>
				</div>
				<div class="ContactForm-formWrapper">
					<div class="ContactForm-inputsWrapper">
							<div class="ContactForm-inputPair">
							<div class="ContactForm-inputWrapper">
								<p>Name <span class="ContactForm-asterix">*</span></p>
								<input placeholder="Enter your name" class="ContactForm-name"></input>
								<div class="ContactForm-nameError">Name must not be blank</div>
							</div>
								<div class="ContactForm-inputWrapper">
								<p>Email <span class="ContactForm-asterix">*</span></p>
									<input placeholder="Enter your email" class="ContactForm-email"></input>
									<div class="ContactForm-emailError">Please enter a valid email</div>
								</div>
							</div>
							<div class="ContactForm-inputPair">
							<div class="ContactForm-inputWrapper">
								<p>Phone <span class="ContactForm-asterix">*</span></p>
									<input placeholder="Enter your phone number" class="ContactForm-phone"></input>
								<div class="ContactForm-phoneError">must contain 10 numbers only</div>
								</div>
								<div class="ContactForm-inputWrapper">
						...
						<p class="ContactForm-messageTitleText">Your message</p>
				...
				<div class="ContactForm-footer">
					<div class="ContactForm-footerContentWrapper">
						...
						<img class="ContactForm-thankYou" src="https://res.cloudinary.com/aptquirks/image/upload/v1617658081/thank_you_wf8rsr.jpg" loading="lazy" />
					</div>
				</div>
			<div>
    </body>
